...
curl -4s --max-time 90 --retry-delay 3 --retry 5 https://raw.githubusercontent.com/antonme/ipnames/master/ext-resolve-vpnhosts.txt >> /tmp/vpnhosts.txt || echo 'failed'
